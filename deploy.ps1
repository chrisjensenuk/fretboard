...
New-AzResourceGroupDeployment -ResourceGroupName $rg -TemplateFile "azuredeploy.json" -TemplateParameterFile "azuredeploy-parameters.json" -location $location -functionAppName $functionAppName -storageAccountName $storageAccountName
